...
public class BalanceChecking {
    ...
    public static double getSystemDouble(double d) {
        return systemDouble(d);
    }

    public static String getDeleteNotUsableSymbols(String str) {
        return deleteNotUsableSymbols(str);
    }
