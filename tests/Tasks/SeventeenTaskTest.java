...
public class SeventeenTaskTest {
    ...
    public Object[][] dataProviderMethod() {
        return new Object[][] {
                { "Boston Celtics:W=4;D=0;L=0;Scored=403;Conceded=350;Points=12","Boston Celtics"},
                {  "Boston Celt:This team didn't play!","Boston Celt"},
        };
    }

    @Test(dataProvider = "data-provider")
    void Test(String result,String input) {
        assertEquals(result, Seventeen.nbaCup(resultSheet3,input));
    }
}
