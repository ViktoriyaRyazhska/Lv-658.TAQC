...
public class SixteenthTest {
    ...
    @Test
    public void test1() {
        Assert.assertEquals(Sixteenth.mean("London", SixteenthTest.data), 51.199999999999996);
        Assert.assertEquals(Sixteenth.variance("London", SixteenthTest.data), 57.42833333333334);
    }

    @Test
    public void test2() {
        Assert.assertEquals(Sixteenth.mean("Beijing", SixteenthTest.data), 52.416666666666664);
        Assert.assertEquals(Sixteenth.variance("Beijing", SixteenthTest.data), 4808.37138888889);
    }
}
