...
public class RainfallTest {
    ...
    @DataProvider(name = "Test-Data-for-Mean-R")
    public Object[][] dataProviderMean() {
        return new Object[][]{
                {"London", 51.199999999999996},
                {"Beijing", 52.416666666666664}};
    }

    @Test(dataProvider = "Test-Data-for-Mean-R")
    public void testMeanR(String town, double expected) {
        assertFuzzyEquals(Rainfall.getMean(town, data), expected);
    }

    @DataProvider(name = "Test-Data-for-Variance-R")
    public Object[][] dataProviderVariance() {
        return new Object[][]{
                {"London", 57.42833333333374},
                {"Beijing", 4808.37138888889}};
    }

    @Test(dataProvider = "Test-Data-for-Variance-R")
    public void testVarianceR(String town, double expected) {
